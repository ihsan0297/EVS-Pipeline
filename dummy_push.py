...
# Configuration
IMAGE_FOLDER = "D:/barcode-test-1"  # Folder containing images to be pushed to RabbitMQ
RABBITMQ_HOST = "localhost"
RABBITMQ_QUEUE = "evs_images_input_queue_test"
import enums
...
def push_images_to_queue():
    ...
    for img in image_files:
        ...
        message = {
            ...
            enums.ROLL_HEADER_ID_COLUMN: 7235064584716101966,
